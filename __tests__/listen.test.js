...
describe('Testing the `.listen` API', () => {
  ...
  test('1 arg to `.listen` should listen to that event on the body', () => {
    ...
    return (
      wait()
        ...
        .then(wait) // Give Typer a moment to get the 1st content on the screen.
        .then(() => {
        ...
        .then(wait) // Give Typer a moment to get the 2nd content on the screen.
  ...
  test('2nd arg to `.listen` as a string should listen to that event on that selector', () => {
    ...
    typer('#test', 1).listen(eventName, '#test').line([content])
    ...
    return (
      wait()
        ...
        .then(wait) // Give Typer a moment to potentially type content.
        .then(() => {
